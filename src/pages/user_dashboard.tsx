    ...
    <div className="grid md:grid-cols-2 gap-6">
      ...
      <div className="md:col-span-2 bg-gray-900/50 border border-green-500/20 rounded-xl p-4">
        <h3 className="text-sm font-semibold text-white mb-4 flex items-center gap-2">
          📊 BACKTEST PERFORMANCE
          <Badge className="text-[9px] bg-blue-600/20 text-blue-300 border-blue-500/30">
            Historical edge validation on resolved markets
          </Badge>
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-black/30 rounded-lg p-3">
            <p className="text-xs text-muted-foreground mb-1">Brier Score</p>
            <p className="font-mono text-lg text-green-400">0.1842</p>
            <p className="text-[9px] text-green-400">Excellent calibration</p>
          </div>
          <div className="bg-black/30 rounded-lg p-3">
            <p className="text-xs text-muted-foreground mb-1">Win Rate</p>
            <p className="font-mono text-lg text-green-400">62.3%</p>
            <p className="text-[9px] text-muted-foreground">Last 30 days</p>
          </div>
          <div className="bg-black/30 rounded-lg p-3">
            <p className="text-xs text-muted-foreground mb-1">Sharpe Ratio</p>
            <p className="font-mono text-lg text-green-400">1.84</p>
            <p className="text-[9px] text-muted-foreground">Risk-adjusted returns</p>
          </div>
        </div>
        <div className="mt-4 p-3 bg-blue-900/20 border border-blue-500/30 rounded-lg">
          <p className="text-xs text-blue-300">
            🔬 Lower Brier = better calibration. Score &lt; 0.2 indicates excellent probability forecasting accuracy.
          </p>
        </div>
      </div>

  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button 
          variant="ghost" 
          className="relative h-8 w-8 rounded-full border border-green-500/30"
        >
      ...
      <DropdownMenuContent className="w-56 border-green-500/30 bg-black/90" align="end" forceMount>

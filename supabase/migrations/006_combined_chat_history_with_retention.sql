-- COMBINED: Chat History Table + Data Retention Policies
-- Run this single migration if you haven't run 006 yet
...
-- ============================================================
-- 2. DATA RETENTION AND CLEANUP POLICIES
-- ============================================================

-- Create a function to clean up old chat history
...
BEGIN
    ...
    EXCEPTION WHEN undefined_table THEN
        -- system_logs table doesn't exist yet, skip logging
        NULL;
    END;
...
-- Create a function to archive old messages instead of deleting
...
BEGIN
    ...
    -- Log the archive operation (if system_logs table exists)
    BEGIN
        INSERT INTO system_logs (log_type, message, created_at)
        VALUES ('archive', 
...
-- Add RLS policies for archive table
...
-- ============================================================
-- 3. ANALYTICS VIEWS AND FUNCTIONS
-- ============================================================
...
-- Grant select permissions for views
